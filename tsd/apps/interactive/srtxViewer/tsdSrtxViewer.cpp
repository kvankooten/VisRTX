...
DockSpace       ID=0x80F5B4C5 Window=0x079D3A04 Pos=0,26 Size=1920,1054 Split=Y
  DockNode      ID=0x00000004 Parent=0x80F5B4C5 SizeRef=1920,797 Split=X
    DockNode    ID=0x00000006 Parent=0x00000004 SizeRef=960,797 CentralNode=1 Selected=0xC450F867
    DockNode    ID=0x00000007 Parent=0x00000004 SizeRef=958,797 Selected=0xA3219422
